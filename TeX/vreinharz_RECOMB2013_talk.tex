...
in Structured RNAs}
\titlegraphic{\includegraphics[width=0.35\textwidth]{Figures/title_fig}}
...
\frame{
	\frametitle{Pyrosequencing}
		\begin{itemize}
			...
			\item Multiple Sequence Alignments and replications to increase confidence 
		\end{itemize}
}
...
%	\scalebox{1.3}{
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{Figures/convergence5.pdf}
	\end{figure}
	\end{minipage}
...
\frame{
	...
	\begin{itemize}
		\item Reconstruct 5s \texttt{rRNA} sequences with random mutations
		\item Length $120$nt, $10\%$ errors
